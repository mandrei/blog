        ...
        */
        ...
        try{
            ...
            DB::transaction(function() use($journal_model,$journal_post_category_model,$journal_post_tag_model,$inputs)
            {
                ...
                //Header journal image extension
                $journal_header_image_extension = $inputs['journal_header_image']->getClientOriginalExtension();

                //GET customer id
                $journal_id = $journal_model->insert_journal_get_id($inputs['meta_description'],$inputs['meta_keywords'],$inputs['post_url'],$inputs['title'],$inputs['post'],$main_journal_image_extension,$journal_header_image_extension,$inputs['featured']);
