...
{{ Form::open(array('admin/journal/category/'.$category_id.'/update', 'POST', 'class' => 'form-horizontal', 'files' => true)) }}
...
<div class="form-group">
        <label class="col-lg-2 control-label">Category header image</label>
        <div class="col-lg-10">
            {{ Form::file('journal_category_header_image') }}
        </div>
</div>
