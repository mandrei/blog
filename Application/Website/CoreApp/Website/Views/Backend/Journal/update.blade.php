...
{{ Form::token() }}
    ...
    <div class="form-group">
      <label class="col-lg-2 control-label">Meta Description</label>
        <div class="col-lg-10">
            <textarea class="form-control" name="meta_description" rows="3">{{ $journal_post->meta_description }}</textarea>
        </div>
    </div>
    ...
    <div class="form-group">
      <label class="col-lg-2 control-label">Meta Keywords</label>
        <div class="col-lg-10">
            <textarea class="form-control" name="meta_keywords" rows="3">{{ $journal_post->meta_keywords }}</textarea>
        </div>
    </div>
    ...
    <div class="form-group">
      <label class="col-lg-2 control-label">Post url</label>
        <div class="col-lg-10">
            <input type="text" class="form-control" name="post_url" value="{{ $journal_post->post_url }}" maxlength="500" placeholder="Post url" />
        </div>
    </div>
...
<div class="form-group">
        <label class="col-lg-2 control-label">Journal header image</label>
        <div class="col-lg-10">
            {{ Form::file('journal_header_image') }}
        </div>
</div>
...
<script type="text/javascript">
    ...
    $('#body').redactor({
        ...
        imageGetJson: webrising.base_url + '/admin/redactor/images'
