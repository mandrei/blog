...
<section class="hero small accent parallax" style="background-image: url(../../../cms/journal_tag_header/{{ $tag_id }}/journal_header.{{ $tag_header_image_extension->journal_tag_header_image_extension }} );">
