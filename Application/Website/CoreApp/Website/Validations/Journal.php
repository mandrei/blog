...
class Journal extends \Abstracts\Validation {
    ...
    public $rules = array(
        ...
        'create' => array(
                            ...
                            'journal_header_image' => 'required|mimes:jpeg,bmp,png,jpg|max:10000'
        ...
        'update' => array(
                            ...
                            'journal_header_image' => 'mimes:jpeg,bmp,png,jpg|max:10000'
        ...
        'create_journal_tag' => array(
                                        ...
                                        'journal_tag_header_image'  => 'required|mimes:jpeg,bmp,png,jpg|max:10000'
        ),
        'update_journal_tag' => array(
                                        ...
                                        'tag_url'                   => 'required|max:500',
                                        'tag_name'                  => 'required|max:255',
                                        'journal_tag_header_image'  => 'mimes:jpeg,bmp,png,jpg|max:10000'
        ),
        'journal_category_create' => array(
                                            ...
                                            'journal_category_header_image' => 'required|mimes:jpeg,bmp,png,jpg|max:10000'
        ),
        'journal_category_update' => array(
                                            ...
                                            'category_url'                  => 'required|max:500',
                                            'category_name'                 => 'required|max:255',
                                            'journal_category_header_image' => 'mimes:jpeg,bmp,png,jpg|max:10000'
        )                              
