...
<head>
    ...
    <!-- Widgets stylesheet -->
    <link href="{{ Request::root() }}/assets/admin_theme_css/widgets.css" rel="stylesheet">
...
<div class="sidebar">
    ...
    <ul id="nav">
        ...
        <li class="has_sub"><a href="#"><i class="fa fa-list-alt"></i> <span>{{ trans("common.journal") }}</span> <span class="pull-right"><i class="fa fa-chevron-left"></i></span></a>
            <ul>
                <li><a href="{{ Request::root() }}/admin/journal/all">{{ trans("common.all") }}</a></li>
                <li><a href="{{ Request::root() }}/admin/journal/create">{{ trans("common.add") }}</a></li>
                         
            </ul>
        </li>

         <li class="has_sub"><a href="#"><i class="fa fa-list-alt"></i> <span>{{ trans("common.journal_categories") }}</span> <span class="pull-right"><i class="fa fa-chevron-left"></i></span></a>

            <ul>
                
               <li><a href="{{ Request::root() }}/admin/journal/categories">{{ trans("common.all") }}</a></li>
                <li><a href="{{ Request::root() }}/admin/journal/category/create">{{ trans("common.add") }}</a></li>
            </ul>

        </li>


        <li class="has_sub"><a href="#"><i class="fa fa-list-alt"></i> <span>{{ trans("common.journal_tags") }}</span> <span class="pull-right"><i class="fa fa-chevron-left"></i></span></a>

            <ul>
                
                <li><a href="{{ Request::root() }}/admin/journal/tags">{{ trans("common.all") }}</a></li>
                <li><a href="{{ Request::root() }}/admin/journal/tag/create">{{ trans("common.add") }}</a></li>
            </ul>
